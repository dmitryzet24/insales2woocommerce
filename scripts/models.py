...
class InSalesProduct(BaseModel):
    ...
    short_description: Optional[str] = Field(defaulr=None, description="Short description")
    description: Optional[str] = Field(defaulr=None, description="Full description")
